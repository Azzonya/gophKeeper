...
import (
	...
	dataItemsModel "gophKeeper/internal/server/domain/dataitems/model"
	dataItemsU "gophKeeper/internal/server/usecase/dataitems"
	usersU "gophKeeper/internal/server/usecase/users"
...
// SyncData handles requests to synchronize data between the adaptor and the server (currently not implemented).
func (s *St) SyncData(_ context.Context, _ *pb.SyncDataRequest) (*pb.SyncDataResponse, error) {
	return nil, nil
}
